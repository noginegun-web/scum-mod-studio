...
Сырые модели из интернета (`.fbx`, `.glb`, `.obj`, `.blend`) сначала нужно импортировать и cook в Unreal Engine 4.27 под Windows. SCUM загружает Unreal assets из pak, а не исходные 3D-файлы.
